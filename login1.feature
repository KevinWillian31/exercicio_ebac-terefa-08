...
Quando insiro usuário "kevin.silva@ebac.com" e senha "Kw123XPTO"  
E sou direcionado para tela de checkout 
...
E e o sistema deve apresentar uma mensagem de erro "Usuário ou senha inválidos"
